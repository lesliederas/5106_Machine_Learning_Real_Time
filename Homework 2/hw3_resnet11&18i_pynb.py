# -*- coding: utf-8 -*-
"""HW3_resnet11&18i.pynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1eR9c8VqPlghhfMa1sUKgPd63DAdo5Os0
"""
...
#ResNet11:have 18 layers in total, including convolutional and fully connected layers.
#it could have 4 residual blocks with a varying number of convolutional layers in each block to make up a total of 11 layers.

# Example of using the ResNet11 model
model = ResNet11(BasicBlock, [2, 2, 2, 2], num_classes=10)  # 4 blocks with 1 layer each
print(model)
